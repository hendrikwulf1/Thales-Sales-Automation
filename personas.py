# --- FILE: personas.py ---
# This file stores the "Writing DNA" for each Sales Rep.
# Currently set up as placeholders. 
# INSTRUCTION: Paste 3-5 example emails inside the triple quotes """ ... """ for each person.
